...
1. Connect your iPad to your computer using a USB cable. For an iPad without a home button, press and quickly release the volume button closest to the power button. Press and quickly release the volume button furthest from the top button. Press and hold the top button.
